...
# Setup database reference for access:
...
# Setting up Flask
# Creating a flash application called "app"
app = Flask(__name__)
...
# - Then will convert our unraveled results into a list. To convert the results to a list, we will need to use the list function, which is list().
# - Then convert the array into a list, then jsonify the list and return it as JSON.
